...
public class AsconaGrassmannDemo extends LogWeightingDemo implements SpinnerListener<ManifoldDisplays> {
  ...
  public AsconaGrassmannDemo() {
    ...
    // ---
    ManifoldDisplays manifoldDisplays = ManifoldDisplays.Se2C;
