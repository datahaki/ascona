...
class PolygonCoordinatesDemo extends ControlPointsDemo {
  ...
  public void spun() {
    ManifoldDisplays selectedMD = getSelectedMD();
    if (selectedMD.equals(ManifoldDisplays.R2)) {
    ...
    if (selectedMD.equals(ManifoldDisplays.H2)) {
      setControlPointsSe2(Tensors.fromString( //
    ...
    if (selectedMD.equals(ManifoldDisplays.S2)) {
      setControlPointsSe2(Tensors.fromString( //
