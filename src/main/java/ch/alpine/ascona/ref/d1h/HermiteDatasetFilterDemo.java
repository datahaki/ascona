...
//
// import ch.alpine.ascona.dat.GokartPoseData;
...
// // ---
// private final GokartPosVel gokartPoseDataV2;
//
// @ReflectionMarker
...
// this(GokartPosVel.RACING_DAY);
// }
//
// public HermiteDatasetFilterDemo(GokartPosVel gokartPoseData) {
...
// super(param);
// this.param = param;
// this.gokartPoseDataV2 = (GokartPosVel) param.gpd();
