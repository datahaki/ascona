...
import ch.alpine.tensor.tmp.TimeSeriesOp;
...
public class TimeSeriesDemo extends ControlPointsDemo {
  ...
  public void render(GeometricLayer geometricLayer, Graphics2D graphics) {
    ...
    visualSet.add(TimeSeriesOp.add(timeSeries, custom)).setLabel("sum");
    visualSet.add(TimeSeriesOp.times(timeSeries, custom)).setLabel("times");
